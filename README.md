...
This gem is tracking the elasticsearch-rails 0.1 branch, which is designed to support Elasticsearch 1.x. If you have another version of Elasticsearch, please use a different branch of this project.
